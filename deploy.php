...
task('deploy:restart_services', function (): void {
    ...
    run('systemctl --user restart oneredpaperclip-queue-work.service oneredpaperclip-inertia-ssr.service oneredpaperclip-schedule-work.service 2>/dev/null || true');
});
