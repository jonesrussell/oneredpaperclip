        ...
        <DropdownMenuContent align="end" class="w-48">
            ...
            >
                <component
                    ...
                    fill="currentColor"
                >
                    <template v-if="link.icon === 'twitter'">
                        <path
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem class="cursor-pointer" @click="copyToClipboard">
                <Check
                    v-if="copied"
                    class="mr-2 size-4 text-[var(--electric-mint)]"
                />
                <Link2 v-else class="mr-2 size-4" />
